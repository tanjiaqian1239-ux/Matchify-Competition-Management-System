...
<link rel="stylesheet" href="../Organiser-css/manage_competition.css">
...
<div class="sidebar">
    ...
    <ul class="menu">
        ...
        <li class="active">
            <a href="management-competition.php">
                <i class="fas fa-trophy"></i>
                <span>Management Competition</span>
            </a>
        </li>
...
<div class="main--content">
    ...
    <div class="card--container">
        ...
        <h3 class="main--title">My Competition Summary</h3>
